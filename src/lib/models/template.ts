...
export interface TemplateModel {
  ...
  text_shadow_vertical: number,
  text_shadow_horizontal: number,
  ...
  side_text_shadow: boolean,
  side_text_shadow_blur: number,
  side_text_shadow_color: string,
  side_text_shadow_vertical: number,
  side_text_shadow_horizontal: number,
